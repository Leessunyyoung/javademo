 ...
 * import 패지키명.클래스;	import java.util.Random;
 ...
 * 2. open API에 제공하는 클래스 : 클래스 및 인터페이스 중복을 피하기 위해서 사용한다.
 * 
 * 		domain : www.gov.kr
 * 		package : kr.gov
 * 
 ...
 * 3.하나의 대상에 여러 개의 제어자를 조합해서 사용할 수 있으나, 접근제어는 단 하나만 사용할 수 있다.
 * 	 접근제어자 - private protected public default(=package)
 ...
 *  variable,method,consrtructor : private, default, protected, public
 *  
 *  
 *  접근제어자 범위

...
//				System.out.printf("%4d",num[row][col]); //1 2 3 4 5 6
//			}
...
//			System.out.println("============================");
//			for(int col=0;col<2;col++) {//0.0 1.0 2.0
//				for(int row=0;row<num.length;row++) { //0.1 1.1 2.2
...
//			System.out.printf("%4d", num[2][1]);
			...
			System.out.println("============================");
			for(int col=0;col<2;col++) {//0.0 1.0 2.0
				for(int row=0;row<3;row++) { //0.1 1.1 2.2
					System.out.printf("%4d",num[row][col]);
				}
				System.out.println();
			}

...
public class Java092_inheritance {
	...
	public static void main(String[] args) {
		...
		//object클래스안에 toString이 정의되어있다.
//		System.out.println("c="+child.c);
		//private는 상속이 안된다. child.c->오류
